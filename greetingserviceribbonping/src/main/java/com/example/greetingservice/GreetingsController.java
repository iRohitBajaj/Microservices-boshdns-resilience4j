...
@RestController
@RibbonClient(name="persondetailsserviceribbonping",
...
public class GreetingsController {
    ...
    ResponseEntity<String> greeting(@PathVariable("name") String name){
        Person person = this.restTemplate.getForObject("http://persondetailsserviceribbonping/person/"+name, Person.class);
