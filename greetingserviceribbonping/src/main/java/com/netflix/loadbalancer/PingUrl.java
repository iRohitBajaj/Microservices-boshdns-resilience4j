...
public class PingUrl implements IPing {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(com.netflix.loadbalancer.PingUrl.class);
    ...
    public static void main(String[] args) {
        com.netflix.loadbalancer.PingUrl p = new com.netflix.loadbalancer.PingUrl(false, "/cs/hostRunning");
